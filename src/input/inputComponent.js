...
export const FormGroup = ({ labelStr, htmlFor, error, children, className, required, customError = null, customLabel = null, LabelInfoComponent, isCreate }) => {
  let errorComp
  ...
  if (LabelInfoComponent && isCreate) {
...
export const InputDate = ({ onChange, id, labelStr, error, value, dateFormat, isClearable, required, customInput, customError, customLabel, LabelInfoComponent, isCreate }) => {
  let date
  if (value) {
    date = new Date(value)
...
// TODO: get classname for invalid from new react-datepicker
export const InputDateTime = ({ onChange, id, labelStr, error, value, dateFormat, timeFormat, isClearable, useUTC, required, customInput, customError, customLabel, LabelInfoComponent, isCreate }) => {
  if (!value) {
    value = ''
  }
...
export const InputString = ({ type, onChange, id, labelStr, error, value, className, required, customInput, customError, customLabel, autoFocus, onKeyDown, spellCheck, LabelInfoComponent, isCreate }) => (
...
export const InputPassword = ({ onChange, id, labelStr, error, value, className, required, customInput, customError, customLabel, autoFocus, onKeyDown, LabelInfoComponent, isCreate }) => (
...
export const InputInt = ({ onChange, id, labelStr, error, value, className, required, customInput, customError, customLabel, autoFocus, onKeyDown, LabelInfoComponent, isCreate }) => {
...
export const InputCurrency = ({ onChange, id, labelStr, error, value, className, required, customInput, customError, customLabel, autoFocus, onKeyDown, LabelInfoComponent, isCreate }) => (
...
export const InputTextArea = ({ onChange, id, labelStr, error, value, className, required, customInput, customError, customLabel, autoFocus, spellCheck, LabelInfoComponent, isCreate }) => (
...
export const InputRadio = ({ onChange, id, labelStr, error, value, className, options, inline, required, customInput, customError, customLabel, LabelInfoComponent, isCreate }) => (
...
export const InputFile = ({ onChange, error, id, labelStr, className, required, customInput, customError, customLabel, LabelInfoComponent, isCreate }) => {
  return (
...
export const InputSwitch = ({ onChange, value, inline, id, className, labelStr, error, required, customInput, customError, customLabel, LabelInfoComponent, isCreate }) => (
...
export const InputSelect = ({ labelStr, id, error, className, isClearable, isMulti, value, options, onChange, noOptionsMessage, onMenuOpen, required, customInput, customError, customLabel, LabelInfoComponent, isCreate }) => (
